...
const AimTrainerLeaderboard: FC = () => {
      ...
      <header className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-baseline sm:justify-between">
        <div>
          <Text variant="subtitle" className="text-slate-100">
            Tygodniowy ranking – Aim Trainer (liczba trafień)
          </Text>
          <Text variant="body-small">
            Liczy się Twój najlepszy wynik z ostatnich 7 dni. Jeden gracz może
            zająć tylko jedno miejsce w TOP 10 – im więcej trafień w 30 sekund,
            tym wyżej.
          </Text>
        </div>
          ...
          <table className="min-w-full text-left text-sm text-slate-100">
            <thead>
              <tr className="border-b border-slate-800 text-xs uppercase tracking-wide text-slate-400">
                ...
                <th className="py-2 pr-4 text-right">Liczba trafień</th>
...
export default AimTrainerLeaderboard;
